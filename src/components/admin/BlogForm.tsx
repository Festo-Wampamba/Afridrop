    ...
    <div className="bg-white rounded-xl border p-6 shadow-sm">
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div>
          ...
          <input id="title" name="title" defaultValue={editPost?.title} required className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
        </div>
        <div>
          <label htmlFor="excerpt" className="block text-sm font-medium text-gray-700 mb-1">Excerpt</label>
          <input id="excerpt" name="excerpt" defaultValue={editPost?.excerpt ?? ''} className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Short summary of the post..." />
        </div>
        ...
        <div>
          ...
          <textarea id="content" name="content" defaultValue={editPost?.content} required rows={10} className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="status" className="block text-sm font-medium text-gray-700 mb-1">Status</label>
            <select id="status" name="status" defaultValue={editPost?.status ?? 'draft'} className="w-full px-3 py-2 border rounded-lg text-sm">
