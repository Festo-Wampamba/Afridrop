...
<head>
    ...
    <title>Access Forbidden - Afridrop Solutions</title>
    <meta name="description" content="You don't have permission to access this page. Explore Afridrop Solutions for professional pool services in Uganda.">
    ...
    <meta name="twitter:title" content="Access Forbidden - Afridrop Solutions">
    <meta name="twitter:description" content="You don't have permission to access this page. Explore Afridrop Solutions for professional pool services in Uganda.">
        ...
        <section class="error-section">
            <div class="container">
                <div class="error-content">
                    ...
                    <p>You don't have permission to access this page. This might be because:</p>
                    <ul class="error-reasons">
                        <li>The page is restricted to authorized users only</li>
                        <li>Your IP address has been blocked</li>
                        <li>You need to log in to access this content</li>
                    </ul>
                ...
                <div class="error-image">
                    <img src="/assets/403-illustration.svg" alt="403 Error Illustration" width="400" height="300">
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="links-grid">
                    <a href="/services" class="quick-link-card">
                        <h4>Our Services</h4>
                        <p>Explore our range of pool services</p>
                    </a>
                    ...
                    <a href="/about" class="quick-link-card">
                        <h4>About Us</h4>
                        <p>Learn more about Afridrop Solutions</p>
                    </a>
