...
<section class="relative py-24 bg-cover bg-center my-12" style="background-image: linear-gradient(to right, rgba(0, 159, 227, 0.85), rgba(0, 84, 166, 0.85)), url('assets/Images/FixingPumpRoom.jpg');"> 
    <div class="container mx-auto px-4 relative z-10"> 
        <div class="max-w-3xl mx-auto text-center text-white"> 
            <h2 class="text-3xl md:text-4xl font-bold mb-4 drop-shadow-md">Expert Pool Equipment Specialists</h2> 
...
<section class="py-16 bg-cover bg-center" style="background-image: linear-gradient(to right, rgba(0, 159, 227, 0.9), rgba(0, 84, 166, 0.9)), url('assets/Images/PoolHero.jpg');"> 
    <div class="container mx-auto px-4"> 
        <div class="text-center text-white"> 
            <h2 class="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Pool Experience?</h2> 
...
<!-- Footer --> 
<footer class="bg-[#002B4A] text-white pt-16 pb-8"> 
    <div class="container mx-auto px-4"> 
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12"> 
            <div> 
                <div class="mb-6"> 
                    <img src="assets/Images/logo_Afridrop_Solutions.png" alt="Afridrop Solutions Logo" class="h-16" loading="lazy"> 
                </div> 
                <p class="text-white/80 mb-6">Uganda's premier swimming pool construction, maintenance, and water treatment provider. We deliver quality pool solutions for residential and commercial clients.</p> 
                <div class="flex space-x-4"> 
                    <a href="https://www.facebook.com/afridrop" class="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors" aria-label="Facebook"> 
                        <i class="ri-facebook-fill"></i> 
                    </a> 
                    <a href="https://www.twitter.com/afridrop" class="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors" aria-label="Twitter"> 
                        <i class="ri-twitter-fill"></i> 
                    </a> 
                    <a href="https://www.instagram.com/afridrop" class="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors" aria-label="Instagram"> 
                        <i class="ri-instagram-fill"></i> 
                    </a> 
                    <a href="https://www.linkedin.com/company/afridrop" class="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors" aria-label="LinkedIn"> 
            ...
            <div> 
                ...
                <ul class="space-y-3"> 
                    ...
                    <li><a href="about.php" class="text-white/80 hover:text-white transition-colors">About Us</a></li> 
                    <li><a href="services.php" class="text-white/80 hover:text-white transition-colors">Services</a></li> 
                    <li><a href="gallery.php" class="text-white/80 hover:text-white transition-colors">Gallery</a></li> 
                    <li><a href="blog.php" class="text-white/80 hover:text-white transition-colors">Blog</a></li> 
                    <li><a href="contact.php" class="text-white/80 hover:text-white transition-colors">Contact</a></li> 
                </ul> 
            </div> 
            ...
            <div> 
                ...
                <ul class="space-y-3"> 
                    <li><a href="services.php#construction" class="text-white/80 hover:text-white transition-colors">Pool Construction</a></li> 
                    <li><a href="services.php#renovation" class="text-white/80 hover:text-white transition-colors">Pool Renovation</a></li> 
                    <li><a href="services.php#maintenance" class="text-white/80 hover:text-white transition-colors">Pool Maintenance</a></li> 
                    <li><a href="services.php#treatment" class="text-white/80 hover:text-white transition-colors">Water Treatment</a></li> 
                    <li><a href="services.php#equipment" class="text-white/80 hover:text-white transition-colors">Equipment Installation</a></li> 
                    <li><a href="services.php#inspection" class="text-white/80 hover:text-white transition-colors">Inspection Services</a></li> 
                </ul> 
            </div> 
